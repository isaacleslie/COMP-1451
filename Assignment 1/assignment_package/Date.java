...
public class Date
{
    ...
    protected static final String[] MONTH_OF_INDEX = {
        JANUARY_STRING,
        FEBRUARY_STRING,
        MARCH_STRING,
        APRIL_STRING,
    ...
    protected static final String DAY_FOR_INDEX[] = {
    ...
    protected static final int MIN_DAY = DEFAULT_DAY;
    ...
    protected static final int ERA4 = 1900;
    ...
    protected static final int ERA4_OFFSET = 0;
    ...
    protected static final short[] MONTHLY_DAY_COUNT = {
    ...
    // Validation prevents this number from exceeding getNumberOfDaysInThisMonth().
    private int day;
    ...
    public void set(int year, int month, int day)
    {
        ...
        if (MIN_YEAR > year || MAX_YEAR < year
            || JANUARY > month || DECEMBER < month
            || MIN_DAY > day || getNumberOfDaysInThisMonth() < day
        )
            setDefaults();        
    } // end mutator
    ...
    public String getDayOfTheWeek() {
        ...
        return DAY_FOR_INDEX[
            (step1Result + step2Result + step3Result + step4Result + step5Result)
                % WEEKDAY_COUNT
        ];
    } // end method
